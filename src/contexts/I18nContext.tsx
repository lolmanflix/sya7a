...
const MESSAGES: Record<Language, Record<string, string>> = {
  en: {
    ...
    plansAndPricing: 'Subscription Plans',
    ...
    egpMonth: 'EGP / month',
    egpMonthPerson: 'EGP / month / person',
    freePrice: '0 EGP',
    proPrice: '20 EGP',
    familyPrice: '17 EGP',
    familyPriceOld: '20 EGP',
    discountBadge: '15% OFF',
    freeFeature1: 'Real-time bus tracking on live map',
    freeFeature2: 'ETA and distance calculation',
    freeFeature3: 'Save up to 5 favorite lines',
    proFeature1: 'Zero ads across the entire app',
    proFeature2: 'In-app digital payment for bus tickets',
    proFeature3: 'Live bus crowdedness and seat capacity indicator',
    familyFeature1: 'Track your family members on map in real time',
    familyFeature2: 'Access to safety mic and camera monitoring feed',
    familyFeature3: 'All Pro benefits included (No ads + payments)',
    subscriptionNote: '* Prices are in Egyptian Pounds (EGP). All plans renew monthly.',
    historyTitle: 'Search History',
    noHistory: 'No History Yet',
    clearHistory: 'Clear History',
    clearHistoryConfirm: 'Are you sure you want to clear all history?',
    routeSavedSuccess: 'Route saved to history',
    busTracker: 'Bus Tracker',
    historyMenu: 'History',
    subscriptionMenu: 'Subscription',
    logoutMenu: 'Logout',
    logoutConfirm: 'Are you sure you want to logout?',
    planSubscribedSuccess: 'Plan Updated Successfully',
  },
  ar: {
    ...
    plansAndPricing: 'خطط والاشتراكات',
    currentPlanActive: 'خطتك الحالية',
    selectPlan: 'اختيار الخطة',
    choosePlan: 'ترقية الآن',
    chooseBestPlan: 'اختر الباقة الأنسب لك',
    mostPopular: '⭐ الأكثر شيوعاً',
    egpMonth: 'جنيه / شهرياً',
    egpMonthPerson: 'جنيه / شهرياً لكل فرد',
    freePrice: '0 جنيه',
    proPrice: '20 جنيه',
    familyPrice: '17 جنيه',
    familyPriceOld: '20 جنيه',
    discountBadge: 'خصم خاص',
    freeFeature1: 'تتبع الحافلات مباشرة على الخريطة',
    freeFeature2: 'حساب المسافة والوقت المتوقع للوصول',
    freeFeature3: 'حفظ ما يصل إلى 5 خطوط مفضلة',
    proFeature1: 'تطبيق خالي تماماً من الإعلانات',
    proFeature2: 'الدفع الإلكتروني المباشر لتذاكر الحافلة عبر التطبيق',
    proFeature3: 'معرفة مدى ازدحام الحافلة والمقاعد المتاحة',
    familyFeature1: 'تتبع هواتف أفراد العائلة مباشرة على الخريطة',
    familyFeature2: 'الوصول المباشر لكاميرا وميكروفون الحافلة لأمان العائلة',
    familyFeature3: 'جميع مزايا الخطة الاحترافية (بدون إعلانات + دفع مباشر)',
    subscriptionNote: '* الأسعار بالجنيه المصري. جميع الخطط تُجدَّد شهرياً.',
    historyTitle: 'سجل البحث والرحلات',
    noHistory: 'لا يوجد سجل حتى الآن',
    clearHistory: 'مسح السجل',
    clearHistoryConfirm: 'هل أنت متأكد من مسح جميع سجلات البحث؟',
    routeSavedSuccess: 'تم حفظ الخط في السجل',
