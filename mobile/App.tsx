...
function AnimatedTabButton({ children, onPress, accessibilityState }: any) {
  ...
  /**
   * Handles navigation tab press event.
   */
  const handlePress = () => {
...
/**
 * Bottom tab navigator for passenger application flows.
 */
function MainTabs() {
...
/**
 * Root stack navigator coordinating role selection, login, and main tabs.
 */
