...
/**
 * Interactive card representing a selectable system user role.
 */
const RoleCard = ({ 
  title, 
  iconName, 
...
/**
 * Initial landing screen allowing selection between Passenger or Driver.
 */
export default function RoleSelectionScreen() {
  ...
  /**
   * Selects a system role and navigates to the respective portal.
   */
