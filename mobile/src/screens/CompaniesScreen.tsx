...
/**
 * Screen browsing transit companies catalog and their operating lines.
 */
export default function CompaniesScreen() {
  ...
  /**
   * Handles user tap on a transit operating company.
   */
  ...
  /**
   * Handles user tap on an operating bus line.
   */
  ...
  /**
   * Renders individual company item card in the FlatList.
   */
  ...
  /**
   * Renders individual bus line item in the company list.
   */
