...
/**
 * Screen displaying commuter past trips and searched routes.
 */
export default function HistoryScreen() {
  ...
  /**
   * Navigates to map tracking for selected historical trip item.
   */
  ...
  /**
   * Clears commuter trip history records.
   */
  ...
  /**
   * Renders a historical trip record item in the FlatList.
   */
  ...
  /**
   * Renders empty state illustration when trip history is blank.
   */
