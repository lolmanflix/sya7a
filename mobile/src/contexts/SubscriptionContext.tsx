...
/**
 * Provides commuter subscription plan state to child components.
 */
export function SubscriptionProvider({ children }: { children: React.ReactNode }) {
  ...
  /**
   * Updates the active commuter subscription tier.
   */
...
/**
 * Accesses commuter subscription tier details and operations.
 */
