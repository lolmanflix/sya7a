...
/**
 * Accesses the active device GPS location and location services.
 */
...
/**
 * Provides GPS coordinate stream and permission states to child components.
 */
export function LocationProvider({ children }: { children: React.ReactNode }) {
  ...
  /**
   * Prompts device for foreground and background location permissions.
   */
  ...
  /**
   * Fetches the current high-accuracy device GPS position once.
   */
  ...
  /**
   * Starts listening for continuous background GPS coordinate updates.
   */
  ...
  /**
   * Halts continuous device GPS coordinate listening.
   */
