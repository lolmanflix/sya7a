...
/**
 * Reusable animated button component with variant styling and loading spinners.
 */
export const Button: React.FC<ButtonProps> = ({
  ...
  /**
   * Triggers button press-out spring release animation.
   */
  ...
  /**
   * Resolves padding and dimension styles based on button size.
   */
  const getSizeStyles = () => {
    switch (size) {
      case 'small':
