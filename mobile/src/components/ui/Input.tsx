...
/**
 * Reusable text input component with floating label, icon, and error validation.
 */
export const Input: React.FC<InputProps> = ({
  ...
  /**
   * Handles text input focus state and animation transitions.
   */
  ...
  /**
   * Handles text input blur event and reset animations.
   */
