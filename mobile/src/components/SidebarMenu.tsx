...
/**
 * Slide-out drawer navigation menu displaying profile, links, and logout action.
 */
export default function SidebarMenu({ visible, onClose }: SidebarMenuProps) {
  ...
  /**
   * Animates the sidebar drawer off-screen before invoking close callback.
   */
  ...
  /**
   * Logs out the authenticated user and closes the drawer.
   */
  const handleLogout = () => {
    Alert.alert(
      t('logoutMenu'),
  ...
  /**
   * Navigates to the specified target screen and dismisses the sidebar.
   */
  ...
  /**
   * Navigates to Commuter History screen.
   */
  ...
  /**
   * Navigates to Live Map tracking screen.
   */
  ...
  /**
   * Opens the Subscription plan upgrade modal.
   */
