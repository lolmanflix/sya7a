...
/**
 * Modal presenting available commuter subscription plan tiers.
 */
export default function SubscriptionModal({ visible, onClose }: Props) {
  ...
  /**
   * Animates subscription modal exit transition.
   */
  ...
  /**
   * Processes plan selection and saves tier to context.
   */
